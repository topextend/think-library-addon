...
// |----------------------------------------------------------------------
// |LastEditTime : 2020-08-13 19:40:14
// |----------------------------------------------------------------------
// |LastEditors  : Jarmin <edshop@qq.com>
// |----------------------------------------------------------------------
// |Description  : Route For Addons Class
// |----------------------------------------------------------------------
// |FilePath     : \think-library\src\addons\Route.php
// |----------------------------------------------------------------------
...
class Route
{
    ...
    public static function execute($addon = null, $controller = null, $action = null)
    {
        ...
        $config['view_path'] = ADDON_PATH . $addon . DIRECTORY_SEPARATOR . 'view' . DIRECTORY_SEPARATOR;
